...
label d2s5edance:
    ...
    e "Tell you what, I'm graceful in victory. You owe me nothing. In fact, allow me to treat you to ice cream."
    # visuals for inside school
    ...
    m "(All of the photos were of the three of us. Some me and Colette, some Colette and Enzo, some Enzo and Colette.)"
...
label d2s5ez12:
    ...
    m "Too much?"
    e "{i}Way{/i} too much!"
    "{size=*0.5}Hmmm maybe I made a mistake…{/size=*0.5}"
    jump d2s5ez15
...
label d2s5ez13:
    ...
    "I'll make a prankster out of you yet."
    jump d2s5ez15

label d2s5ez14:
    $ increase_affinity("Enzo", 1)
    e "Not bad at all…"
    "Pretty sneaky, [playerName]."
    # enzo proud of self, whatever visual works best for that
    "I can see you've drawn inspiration from my mysterious chicken number three, in fact."
    m "Oh yeah… I guess it's kind of the same idea you're already doing."
    e "Don't worry. A for effort."
    "And you know a grade means a lot coming from {i}me{/i}."
    jump d2s5ez15
